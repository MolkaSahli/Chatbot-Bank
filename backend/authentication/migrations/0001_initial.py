    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("contact", models.CharField(max_length=20, verbose_name="Téléphone")),
                (
                    "email",
                    models.EmailField(
                ...
                (
                    "is_first_login",
                    models.BooleanField(
                        default=True, verbose_name="Première connexion"
                    ),
                ),
                (
                    "totp_secret",
                ...
                (
                    "backup_codes",
                    models.TextField(
                        blank=True, null=True, verbose_name="Codes de secours"
                    ),
                ),
                (
                    "date_joined",
